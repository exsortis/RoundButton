#
#  Be sure to run `pod spec lint PurchaseHelper.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.authors            = { "Paul Schifferer" => "pilgrim@pilgrimagesoftware.com" }
  s.social_media_url   = "http://twitter.com/brickdm"
